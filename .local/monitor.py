...
subscription_id = "ca9561eb-2cc9-48f9-8885-4c4ae7a4add5"
resource_group = "rg-rag-project-dev"
aoai_deployment_name = "gpt-4"
aoai_connection_name = "aoai-connection"
project_name = "ai-project-j5tbeevwk5yta"  # Ex: ai-project-lh7b37cbhixdq
endpoint_name = "rag-22222-endpoint"  # Ex: rag-PCLN-endpoint
deployment_name = "rag-22222-deployment"  # Ex: rag-PCLN-deployment
